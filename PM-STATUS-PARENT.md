...
| T17 | Visit reject + failed_3x override                                                | B    | Nathan  | approved | PM B (Nathan) | ✅ APPROVED attempt 1 (2026-07-02). PM rerun: make check 219 (no-Docker) + coverage 96.48% + drift clean + merge dry-run CLEAN + T16 regression clean. `feat/visits-reject-override` @ `cb705f4` → **awaiting PO merge**. Unblocks T18. |
