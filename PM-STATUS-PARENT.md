...
| T15 | Guest messages history                                                           | B    | Nathan  | approved | PM B (Nathan) | ✅ APPROVED attempt 1 (2026-07-02). PM rerun: make check 144 + coverage 97.46% + drift clean + merge dry-run CLEAN. Code `feat/guest-messages` @ `1355204` → **awaiting PO merge**. |
