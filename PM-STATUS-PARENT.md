...
| T14 | Guests CRUD + preferences                                                        | B    | Nathan  | assigned | —           | Issued 2026-07-01. Greenfield `guests/`. **Parallel batch** w/ T16 (Q-B-05 Visit shape ratified). Awaiting PLAN. |
| T15 | Guest messages history                                                           | B    | Nathan  | backlog  | —           | After T14                                          |
| T16 | Visits list + pending verification flow                                          | B    | Nathan  | assigned | —           | Issued 2026-07-01 (parallel batch). Greenfield `visits/`, owns canonical Visit serializer (Q-B-05). Parallel w/ T14. Awaiting PLAN. |
| T17 | Visit reject + failed_3x override                                                | B    | Nathan  | backlog  | —           | After T16                                          |
| T18 | Manual visit create                                                              | B    | Nathan  | backlog  | —           | After T16                                          |
| T19 | Notifications CRUD + optimistic ops                                              | B    | Nathan  | assigned ⛔ | —          | Issued 2026-07-01 but **BLOCKED on DEP-5** (`TenantContext.userId`, Slot A). May PLAN; impl waits. |
