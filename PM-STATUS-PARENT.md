...
| T14 | Guests CRUD + preferences                                                        | B    | Nathan  | approved | PM B (Nathan) | ✅ APPROVED attempt 1 (2026-07-02). PM rerun: make check 131 + coverage 97.95% + drift clean + merge dry-run into main CLEAN. Code `feat/guests-crud` @ `f4c4fd8` → **awaiting PO merge (merge FIRST)**. |
