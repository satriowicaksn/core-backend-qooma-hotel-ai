...
| T15 | Guest messages history                                                           | B    | Nathan  | wip      | —           | PLAN ACK'd 2026-07-02. Q-B-10 ratified (aggregate `ticket_messages`, newest-first, cursor). Coding `feat/guest-messages`. |
