...
| T13 | Ticket stats + overdue                                                           | B    | Nathan  | approved | PM B (Nathan) | ✅ APPROVED attempt 1 (2026-07-01). PM rerun: make check 93 + integration 17 + coverage 96.66% + drift clean + T11 regression green. `is_overdue` SSOT coherence fix verified. Code `feat/tickets-stats-overdue` @ `3a6af90` → **awaiting PO merge**. |
| T14 | Guests CRUD + preferences                                                        | B    | Nathan  | assigned | —           | Issued by PM B 2026-07-01. Greenfield `guests/`. Awaiting exec-B PLAN. Q-B-04/Q-B-05 open. |
