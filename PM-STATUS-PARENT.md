...
| T19 | Notifications CRUD + optimistic ops                                              | B    | Nathan  | wip      | —           | PLAN ACK'd 2026-07-02. Q-B-07 ruled (envelopes). Per-user scope (no super_admin bypass). Coding `feat/notifications-crud`. |
