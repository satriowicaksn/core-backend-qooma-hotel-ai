...
| T12 | Ticket status transition + reroute (state-machine-validated)                     | B    | Nathan  | wip      | —           | PLAN ACK'd 2026-07-02 (T06+DEP-6+DEP-5 all merged). Q-B-11 → `ctx.userId`. Coding `feat/tickets-transition`. |
