...
| T13 | Ticket stats + overdue                                                           | B    | Nathan  | wip      | —           | PLAN ACK'd by PM B 2026-07-01 (+ required is_overdue coherence fix). Q-B-03 stats shape ratified. Coding `feat/tickets-stats-overdue`. Extends `tickets` module. |
