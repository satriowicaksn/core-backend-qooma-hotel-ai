...
| T14 | Guests CRUD + preferences                                                        | B    | Nathan  | wip      | —           | PLAN ACK'd 2026-07-02. Q-B-04 ratified. Coding `feat/guests-crud`. Parallel w/ T16. |
| T15 | Guest messages history                                                           | B    | Nathan  | backlog  | —           | After T14                                          |
| T16 | Visits list + pending verification flow                                          | B    | Nathan  | wip      | —           | PLAN ACK'd 2026-07-02. GAP #1/#2/#3 approach A; Q-B-09 (visit audit table) → §3c. Coding `feat/visits-list-verify`. Parallel w/ T14. |
